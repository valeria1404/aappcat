<?php
$mysqli = new mysqli("127.0.0.1", "root", "Shana2701", "appcat");
$mysqli->query("INSERT INTO registro VALUES ('Valeria','12345', 'vale@oo', 'cedetec');");
...
$mysqli = new mysqli("127.0.0.1", "root", "Shana2701", "prueba", 3306);
if ($mysqli->connect_errno) {
    echo "Fallo al conectar a MySQL: (" . $mysqli->connect_errno . ") " . $mysqli->connect_error;
}
